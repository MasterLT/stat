			...
			<div class="col-xs-8" style="display: flex;">
				<div id="reportrange" class="input-prepend input-group" data-date-format="yyyy-mm-dd hh:ii:ss">
					...
					<input id="endDate" name="endDate" value="${endDate}" type="hidden">
					 <input type="text" style="width: 200px" name="timeSection"id="rangeDate" class="form-control" value="" class="span4" />
				</div>
...
<script type="text/javascript">
	function search(){
		...
		window.open("disAnalysis/chart"+"?beginDate="+beginDate+"&endDate="+endDate+"&region="+$('#district').val());
