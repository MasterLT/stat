...
public class PageBean implements Serializable {
	...
	/**
	 * 得到总共有多少条记录.libo 2015-4-30，将64bit的long强制改为32bit的Integer，一般一个查询结果条数不太可能超过32bit的表示范围吧？
	 * 
	 * @return
	 */
	public Integer getRecordCount() {
		...
		return (pageCount - 1) * pageSize + lastPageSize;//libo 2015-4-30，将64bit的long强制改为32bit的Integer，一般一个查询结果条数不太可能超过32bit的表示范围吧？
	}
